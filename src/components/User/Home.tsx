      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-10">
          <div className="flex justify-center mb-4">
            <img src="src/assets/user/category/olive_branch.png" alt="Decorative Design" className="w-16 h-auto" />
          </div>
          <h2 className="text-5xl font-bold mb-20 mt-10 text-center font-serif text-customGray">Our Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="flex flex-col items-center">
              <img
                src="src/assets/user/category/mehendi.jpg"
            ...
            <div className="flex flex-col items-center">
              <img
                src="src/assets/user/category/makeup.jpg"
            ...
            <div className="flex flex-col items-center">
              <img
                src="src/assets/user/category/bridal.jpg"
                alt="Mini Planner"
        ...
        <section className="py-10">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-16 sm:mt-24 mb-16 sm:mb-32 justify-items-center">
              <img
                src="./src/assets/user/category/mehdi.jpeg"
                alt="Partner 1"
                className="h-32 sm:h-48 w-full sm:w-auto object-cover"
              />

              <img
                src="./src/assets/user/category/le paris.png"
                alt="Partner 2"
                className="h-32 sm:h-48 w-full sm:w-auto object-cover"
              />

              <img
                src="./src/assets/user/category/kulz.png"
                alt="Partner 3"
                className="h-32 sm:h-48 w-full sm:w-auto object-cover"
              />
            </div>
        ...
        <section className="relative bg-cover bg-center py-32" style={{ backgroundImage: "url('src/assets/user/banner/banner2.jpg')" }}>
          <div className="absolute inset-0 bg-white opacity-80"></div>
          <div className="container mx-auto text-center relative z-10">
            <div className="flex justify-center mb-4">
              <img src="src/assets/user/category/olive_branch.png" alt="Decorative Icon" className="w-16 h-auto" />
            </div>
